...
## functions do
## These two functions are used to calculate the inverse of a matrix when 
## the matrix has been cached before the inverse of a matrix will be returned 
## right now rather than compute it repeatedly. 
...
## o	set the inverse of the matrix
## o	get the inverse of the matrix
